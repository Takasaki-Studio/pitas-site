...
export namespace Prisma {
  ...
  */
  ...
  type GetLinksGroupByPayload<T extends LinksGroupByArgs> = Promise<
    Array<
  ...
  export type LinksGetPayload<
    ...
    : 'select' extends U
    ? {
    [P in TrueKeys<S['select']>]: P extends keyof Links ?Links [P]
  : 
     never
  } 
    : Links
  ...
  export interface LinksDelegate<GlobalRejectSettings> {
    ...
    **/
    ...
    >(args: SubsetIntersection<T, LinksGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetLinksGroupByPayload<T> : Promise<InputErrors>
  }
